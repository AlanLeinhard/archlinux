...
sudo pacman -S telegram-desktop firefox docker lshw util-linux-libs wmctrl steam discord audacity krita kdenlive obs-studio mpg123 mpv ntfs-3g wine winetricks protontricks git gvfs ccache grub-customizer neofetch --noconfirm
